    ...
    def loads(self, authfile):
        ...
        for line in fp:
            ...
            # Break at the first equals sign
                ...
                elif key in ('show_player_command', 'debug', 'use_color', 'dvr_record_only', 'live_from_start', 'use_nexdef', 'adaptive_stream', 'show_inning_frames', 'postseason', 'use_librtmp', 'no_lirc'):
                    if val.isdigit():
